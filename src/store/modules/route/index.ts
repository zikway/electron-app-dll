...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
   ...
   * Auth route mode
   *
   * It recommends to use static mode in the development environment, and use dynamic mode in the production environment, if use static mode in
   * development environment, the auth routes will be auto generated by plugin "@elegant-router/vue"
   */
